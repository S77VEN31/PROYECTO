...
}) satisfies z.ZodType<EntityBase>;
 ...
 */
export const FullMetadataSchema = EntityMetadataSchema.merge(
  SeoMetadataSchema
) satisfies z.ZodType<FullMetadata>;

/**
 * Schema for creating entities with partial metadata
 */
export const PartialMetadataSchema =
  EntityMetadataSchema.partial() satisfies z.ZodType<PartialMetadata>;
